...
import static com.socket.ServerThread.streamIn;
import java.io.*;
import java.net.*;
...
class ServerThread extends Thread { 
    ...
    public static ObjectInputStream streamIn  =  null;
	...
	if (msg.content.equals(".bye")){
            ...
            if(msg.type.equals("login")){
                ...
                if(msg.recipient.equals("All")){
                    ...
                    findUserThread(msg.recipient).send(new Message(msg.type, msg.sender, msg.content, msg.recipient,null));
                    clients[findClient(ID)].send(new Message(msg.type, msg.sender, msg.content, msg.recipient,null));
                }
            }
                ...
                if(findUserThread(msg.sender) == null){
                    if(!db.userExists(msg.sender)){
                        ...
                        db.addUser(msg.sender, msg.info[1].toString(),msg.info[3],msg.info[4],msg.info[5],msg.info[6],msg.info[7]);
                        clients[findClient(ID)].username = msg.sender;
            ...
            else if(msg.type.equals("statut")){
                    db.statut(msg.content,msg.sender);
                    
                }
                
                else if(msg.type.equals("get")){
               Object[] t;
                 t=   db.getinfo(msg.content);
                 clients[findClient(ID)].username = msg.sender;
                 clients[findClient(ID)].send(new Message("get", "SERVER", "TRUE", msg.sender,t));
